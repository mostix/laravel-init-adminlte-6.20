...
@section('title')
    {{__('custom.edit')}} {{trans_choice('custom.roles', 1)}}
@endsection
...
@section('header')
    <ol class="breadcrumb">
        ...
        <li class="active">{{__('custom.edit')}} {{trans_choice('custom.roles', 1)}}</li>
    </ol>
@endsection
...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title my-2">{{__('custom.edit')}} {{trans_choice('custom.roles', 1)}}</h3>

            <form action="{{ route('admin.roles.update',$role->id) }}" method="post" role="form" id="form"
